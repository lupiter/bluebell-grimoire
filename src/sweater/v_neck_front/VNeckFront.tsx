    ...
    return (
        <>
            ...
            <ol>
                ...
                <li>Work on half the stitches nearest carriage, placing other half out of action, {sideStitchesCount()} stitches</li>

                <em>At the same time do steps 8, 9 & 10...</em>
                <li>At armhole edge decrease 1 stitch every row {armShapeBottom()} times</li>
                <li>At armhole edge decrease 1 stitch each end every 2nd row {armShapeTop()} times</li>
                <li>At neck edge decrease 1 stitch every 4th row {neckShape()} times</li>
                <li>There are now {widthAfterShaping()} stitches</li>
                <li>Knit straight to {sleeveRows()} rows</li>
                <li>At beginning of every 2nd row, at armhole edge cast off {shoulderStitches()} stitches, {shoulderRows()} times</li>
