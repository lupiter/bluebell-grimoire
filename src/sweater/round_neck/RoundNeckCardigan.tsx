...
export function RoundNeckCardigan({width, length, shelf, scoop = false}: {width: number, length: number, shelf: number, scoop: boolean}) {
    ...
    return (
        <>
            <h3>Round Neck Front (Make 2, 2nd Mirrored)</h3>
            <ol>
